...
siddharth1= webdriver.Chrome(executable_path="chromedriver")#In executable path give the path of chromedriver that you have downloaded. In my case it is in downloads.
siddharth2= webdriver.Chrome(executable_path="chromedriver")
siddharth3= webdriver.Chrome(executable_path="chromedriver")
